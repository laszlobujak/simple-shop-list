        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="border-2 border-amber-200 dark:border-amber-800 bg-amber-50/50 dark:bg-amber-950/20">
              <CardHeader>
                <CardTitle className="font-serif text-2xl text-center">
                  Segítsen nekünk jobbá válni!
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-muted-foreground text-center leading-relaxed">
                  Az AI rendszerünk folyamatosan tanul és fejlődik. Ha úgy érzi,
                  hogy a becslés nem tükrözi pontosan az ékszere értékét, kérjük
                  jelezze nekünk – minden visszajelzés segít, hogy egyre pontosabb
                  becsléseket adhassunk. Szakértőink szívesen átnézik tárgyát
                  személyesen is.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    size="lg"
                    variant="outline"
                    className="text-lg py-6 border-2 border-amber-500 hover:bg-amber-100 dark:hover:bg-amber-900/30"
                    asChild
                  >
                    <Link href="/kapcsolat">Írjon nekünk</Link>
                  </Button>
                  <Button
                    size="lg"
                    variant="outline"
